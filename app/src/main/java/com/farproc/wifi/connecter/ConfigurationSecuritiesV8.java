...
//默认“未知安全加密方式”
	 ...
	 * Use clear if you want to reuse this BitSet with the same capacity, 
	 * but create a new BitSet if you're trying to potentially reclaim memory.
	 */
	private void clearBitSet(WifiConfiguration config) {
